<template>
  <div class="dropdown-wrapper">
    ...
    <div @mousedown="isTouched = true" @click="dropdownVisible = !dropdownVisible" class="dropdown-block" :class="{'dropdown-block-open': dropdownVisible}" v-click-outside="close">
